    ...
    <div class="module-body">
      ...
      <div class="composer">
        ...
        <div class="composer-actions">
          <n-button size="small" tertiary :disabled="pending" @click="clear">清空对话</n-button>
...
.chat-board{flex:1;min-height:280px;overflow:auto;border:1px solid var(--color-border);border-radius:10px;background:#f8fafc;padding:12px;display:flex;flex-direction:column;gap:10px}
...
.composer-actions{display:flex;align-items:center;justify-content:flex-start;gap:10px;position:sticky;bottom:0;left:0;background:#fff;padding-top:2px}
